  ...
  return (
    <View style={styles.screen}>
      <FlatList 
            ...
            <View style={styles.card}>
              ...
              {isExpanded ? (
                <View style={{ marginTop: 10 }}>
                  <RenderHtml contentWidth={width} source={{ html: item.description }} tagsStyles={{ p: { color: theme.text } }}
                  />
                  <TouchableOpacity onPress={() => toggleExpand(item.id)}>
                    <Text style={{ color: theme.primary, marginTop: 5 }}>Show Less</Text>
                  </TouchableOpacity>
                </View>
              ) : (
              ...
              <View style={{ flexDirection: 'row', gap: 10, marginTop: 10 }}>
                ...
                <TouchableOpacity 
                    ...
                    onPress={() => navigation.navigate('Apply', { fromSaved: true })}
                >
        ...
        ListEmptyComponent={<Text style={[styles.text, { textAlign: 'center', marginTop: 20 }]}>No saved jobs yet.</Text>} 
      />
    </View>
  );
};